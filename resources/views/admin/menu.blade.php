<aside class="main-sidebar">
    ...
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li><a href="backend/news?type=khuyen-mai"><i class="fa fa-circle-o"></i> <span>Khuyến mại</span></a></li>
            <li><a href="backend/news?type=khach-hang"><i class="fa fa-circle-o"></i> <span>Khách hàng dự án</span></a></li>
            <!-- <li class="treeview">
              <a href="#">
                <i class="fa fa-dashboard"></i> <span>Tin tức</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
